              ...
              <div class="container-fluid" id="pengaduan">
                <div class="row">
                  <div class="col-md-8 py-5 ">
                    ...
                    <div>
                      <p class="fs-6 fw-lighter fst-italic" style="color:red;">Note : Anda bisa mengubah data pengaduan
      ...
      <section id="proses">
        <div class="container">
          ...
          <table border="1" class="table table-striped">
            ...
            if (isset($_GET['cari'])) {
              $cari = $_GET['cari'];
              $query = "SELECT idlaporan,prosespengaduan.npm,nama,program_studi,isiaduan,tanggal,statuspengaduan,foto FROM prosespengaduan INNER JOIN users WHERE idlaporan LIKE '%$cari%' and prosespengaduan.npm = users.npm and prosespengaduan.npm=$npmm ";
              $result = mysqli_query($koneksi, $query);
            } else {
                ...
                <td style="width: 150px;">
                  ...
                  <!-- <?php //if ($status == "Diproses") { 
                    ...
                    <button type="button" class="btn  btn-sm btn-warning disabled">
                      Edit
                    </button><?php //} elseif ($status == "Berhasil terkirim") { 
                              ?><form action="self.php?idlaporan=<?= $row['idlaporan'] ?>" method="post"><button class="btn btn-sm btn-warning"
                  ...
                  <?php if ($status == "Diproses") { ?> <a href="hapus.php?id=<?php echo $row['idlaporan'] ?>" class="btn btn-sm btn-secondary disabled">Hapus</a><?php } elseif ($status == "Berhasil terkirim") { ?><a href="hapus.php?idlaporan=<?php echo $row['idlaporan'] ?>" class="btn btn-sm btn-danger ">BATAL</a><?php } ?>
                </td>
              </tr>
          <?php }
          } ?>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-2 col-md-6 footer-links">
              <h4>Our Website</h4>
              <ul>
                <li><i class="bx bx-chevron-right"></i> <a href="https://www.methodist.ac.id/home.do" target="_blank">Universitas Methodist Indonesia</a></li>
                <li><i class="bx bx-chevron-right"></i> <a href="https://simak.methodist.ac.id/login.do" target="_blank">Simak Umi</a></li>
                <li><i class="bx bx-chevron-right"></i> <a href="https://www.instagram.com/universitasmethodistindonesia/?hl=en" target="_blank">Social Media</a>
                </li>
              </ul>
            </div>
            ...
            <div class="col-lg-2 col-md-6 footer-links">
              <h4>Fakultas UMI</h4>
              <ul>
                <li><i class="bx bx-chevron-right"></i><a href="https://www.methodist.ac.id/content.do?tid=FakultasSastra&pid=33" target="_blank">Fakultas
                    Sastra</a></li>
                <li><i class="bx bx-chevron-right"></i><a href="https://www.methodist.ac.id/content.do?tid=FakultasKedokteran&pid=33" target="_blank">Fakultas
                    Kedokteran</a></li>
                <li><i class="bx bx-chevron-right"></i><a href="https://www.methodist.ac.id/content.do?tid=FakultasPertanian&pid=33" target="_blank">Fakultas
                    Pertanian</a></li>
                <li><i class="bx bx-chevron-right"></i><a href="https://www.methodist.ac.id/content.do?tid=FakultasEkonomi&pid=33" target="_blank">Fakultas
                    Ekonomi</a></li>
                <li><i class="bx bx-chevron-right"></i><a href="https://www.methodist.ac.id/content.do?tid=FakultasIlmuKomputer&pid=33" target="_blank">Fakultas
                    Ilmu Komputer</a></li>
              </ul>
            </div>
